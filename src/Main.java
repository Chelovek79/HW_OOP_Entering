public class Main {
    ...
    public static void main(String[] args) {
        ...
        Automobile car1 = new Automobile("Toyota", "Mark II", 3.0,
                "White Pearl",1992, "Япония");

        Automobile car2 = new Automobile("Audi","A8 50L TDI quattro", 3.0,
                "Чёрный",2020, "Германия");

        Automobile car3 = new Automobile("BMW", "Z8", 3.0,
                "Чёрный", 2021, "Германия");

        Automobile car4 = new Automobile("Kia", "Sportage IV", 2.4,
